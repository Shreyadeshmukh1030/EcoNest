...
- **JavaScript** – Interactivity and basic dynamic features
...
- Fast-loading static website using CDN

---

## 🌍 Sustainability Focus
EcoNest emphasizes:
- **Eco-friendly and artisan-made products**
- Reduction of **plastic usage**
- Lower **carbon footprint**
- Promotion of **ethical and sustainable living**

---

## 🚀 Deployment
The project is deployed using **Netlify**, which provides secure HTTPS hosting and CDN-based performance optimization.
